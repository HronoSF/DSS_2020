...
export const vkAccessTokenURLWithProxy = `${proxyURL}/access_token?client_id=${vkAppID}&client_secret=${vkAppSecret}&redirect_uri=${appURL}`;

export const vkOpenAuthDialogURL = `https://oauth.vk.com/authorize?client_id=${vkAppID}&display=popup&redirect_uri=${appURL}&response_type=code&v=5.122`;
